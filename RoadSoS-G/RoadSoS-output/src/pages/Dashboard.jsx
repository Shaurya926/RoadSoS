  ...
  return (
    <div className="min-h-screen bg-gradient-dark">
      <div className="max-w-5xl mx-auto px-4 py-12">
        ...
        <div className="mb-8 animate-slide-up" style={{ animationDelay: "290ms" }}>
          ...
          >
            <div className="flex flex-col gap-6">
              ...
              <div className="grid gap-3 sm:grid-cols-2">
                <button
                  type="button"
                  onClick={() => navigate("/accident-severity")}
                  className="rounded-2xl bg-amber-500/20 hover:bg-amber-500/30 border border-amber-500/40 px-6 py-4 text-sm font-bold text-amber-300 transition duration-300 hover-lift"
                >
